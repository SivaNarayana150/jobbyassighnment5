...
import SimilarJobs from './SimilarJobs' // Assuming SimilarJobs component is imported
...
class AboutJobItem extends Component {
  ...
  getJobData = async props => {
    ...
    if (response.ok === true) {
      ...
      const updatedJobDetails = [fetchedJobData.job_details].map(eachItem => ({
